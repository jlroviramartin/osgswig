...
//#BEGIN Feature
    ...
    %ignore osgEarth::Features::FeatureModelOptions::getConfig() const; // No compila.
    %ignore osgEarth::Features::FeatureModelOptions::fromConfig/*(class osgEarth::Config const &)*/; // No compila.
    %ignore osgEarth::Features::FeatureModelOptions::FeatureModelOptions/*(class osgEarth::ConfigOptions const &)*/; // No compila.
