...
//#BEGIN GLExtensions
    %cs_RefUnref(osg::GLExtensions)

    namespace osg {
        class GLExtensions : public osg::Referenced {
        public:
...
//#BEGIN Callback
    %cs_RefUnref(osg::Callback)
    %cs_RefUnref(osg::CallbackObject)
    %cs_RefUnref(osg::NodeCallback)
    %cs_RefUnref(osg::StateAttributeCallback)
    %cs_RefUnref(osg::UniformCallback)

    %ignore osg::Callback::getNestedCallback() const;

    %feature("director") osg::NodeCallback;
    %feature("director") osg::StateAttributeCallback;
    %feature("director") osg::UniformCallback;

    %rename(Execute) osg::NodeCallback::operator ();
    %rename(Execute) osg::StateAttributeCallback::operator ();
    %rename(Execute) osg::UniformCallback::operator ();

    %rename(OSGCallback) osg::Callback;
...
//#BEGIN BufferObject
    ...
    %cs_RefUnref(osg::AtomicCounterBufferObject)
    %cs_RefUnref(osg::BufferData)
    %cs_RefUnref(osg::BufferData::ModifiedCallback)
    ...
    %cs_RefUnref(osg::ShaderStorageBufferObject)
...
//#BEGIN MixinVector
    ...
    namespace osg {
        ...
        %template(PNodeMixinVector) osg::MixinVector< osg::Node* >;
    }
...
%}
    ...
    %rename(Drawable_getInitialBound) osg::Drawable::getInitialBound() const;
    %rename(Drawable_setInitialBound) osg::Drawable::setInitialBound(const osg::BoundingBox& bbox);
    //%ignore osg::Drawable::CullCallback::run;
...
//#BEGIN CullSettings
    %cs_RefUnref(osg::CullSettings::ClampProjectionMatrixCallback)
...
//#BEGIN OcclusionQueryNode
    ...
    %cs_RefUnref(osg::TestResult)
    %cs_RefUnref(osg::QueryGeometry)
...
//#BEGIN BufferIndexBinding
    ...
    %cs_RefUnref(osg::AtomicCounterBufferBinding)
    %cs_RefUnref(osg::ShaderStorageBufferBinding)
...
%}
    ...
    %cs_RefUnref(osg::GraphicsContext::SwapCallback)
    %cs_RefUnref(osg::GraphicsContext::ResizedCallback)
    %cs_RefUnref(osg::GraphicsContext::Traits)
    %cs_RefUnref(osg::SyncSwapBuffersCallback)
...
//#BEGIN View
    ...
    %cs_RefUnref(osg::View::Slave::UpdateSlaveCallback)
...
//#BEGIN Texture2DArray
    ...
    %cs_RefUnref(osg::Texture2DArray::SubloadCallback)
...
//#BEGIN Texture3D
    ...
    %cs_RefUnref(osg::Texture3D::SubloadCallback)
...
//#BEGIN TextureCubeMap
    ...
    %cs_RefUnref(osg::TextureCubeMap::SubloadCallback)
...
//#BEGIN TextureRectangle
    ...
    %cs_RefUnref(osg::TextureRectangle::SubloadCallback)
...
//#BEGIN State
    ...
    %cs_RefUnref(osg::State::DynamicObjectRenderingCompletedCallback)
    ...
    %ignore osg::State::DefineMap;
    %ignore osg::State::DefineStack;
    %ignore osg::State::UniformStack;
    %ignore osg::State::AttributeStack;
    %ignore osg::State::ModeStack;
...
//#BEGIN Shader
    ...
    %cs_RefUnref(osg::Shader::ShaderObjects)
...
//#BEGIN ShaderComposer
    ...
    %rename(ShaderComposer_releaseGLObjects) osg::ShaderComposer::releaseGLObjects(osg::State*);
    %include <osg/ShaderComposer>
//#END ShaderComposer
...
//#BEGIN Program
    ...
    %cs_RefUnref(osg::Program::ProgramObjects)
    %include <osg/Program>
//#END Program
